...
;
;
TrayTip "RBG:" RedShutter  ", " BlueShutter  ", " GreenShutter  "`nGain: " RedGain  ", " BlueGain  ", " GreenGain
A_Clipboard := "RBG:" RedShutter  ", " BlueShutter  ", " GreenShutter  "`nGain: " RedGain  ", " BlueGain  ", " GreenGain
;
